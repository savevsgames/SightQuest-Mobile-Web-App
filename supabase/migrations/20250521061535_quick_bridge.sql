/*
  # Improved Stripe Integration Schema

  1. Changes
    - Use Stripe IDs (cus_*, sub_*, etc.) as primary keys
    - Add ON DELETE CASCADE for proper cleanup
    - Add service role policies for webhook access
